    ...
    <MainLayout>
      <div className="flex flex-col items-center mx-40 mt-20">
        ...
        <section className="flex flex-col items-center mt-20">
          ...
          <ol>
            <li className="flex flex-col items-center mt-10">
              <p className="text-black text-lg">1. [회원가입] 창에서 회원정보 입력하기</p>
        ...
        <section className="flex flex-col items-center mt-20">
          ...
          <ol>
            <li className="flex flex-col items-center mt-10">
              <p className="text-black text-lg">1. AI가 추천하는 밀리루틴</p>
              <img src="/pages/Landing.jpg" className="mt-10" />
            </li>
            <li className="flex flex-col items-center mt-10">
              <p className="text-black text-lg">2. 테마별/인기 밀리루틴 보기</p>
              <img src="/pages/Popular.jpg" className="mt-10" />
            </li>
            <li className="flex flex-col items-center mt-10">
              <p className="text-black text-lg">3. [나의 밀리루틴] - [밀리루틴 개설하기] 탭에서 밀리루틴을 직접 개설할 수도 있습니다!</p>
        ...
        <section className="flex flex-col items-center mt-20 mb-20">
          ...
          <ol>
            <li className="flex flex-col items-center mt-10">
              <p className="text-black text-lg">1. 참여율에 따라 경험치와 포인트를 얻을 수 있습니다</p>
              <img src="/pages/Detail.jpg" className="mt-10" />
            </li>
            <li className="flex flex-col items-center mt-10">
              <p className="text-black text-lg">2. [포인트샵]에서 원하는 상품을 구매해보세요</p>
              <img src="/pages/Pointshop.jpg" className="mt-10" />
            </li>
            <li className="flex flex-col items-center mt-10">
              <p className="text-black text-lg">3. [나의 밀리루틴] - [인증하기]에서 인증 시 사용했던 이미지와 글을 다시볼 수 있습니다</p>
